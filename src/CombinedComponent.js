    ...
    return (
        <div className="app">
            <header className="header">
                <img src={photo} alt="M.int icon" className="mint-icon" />
                ...
                {loading ? (
                    ...
                    <>
                        <div className="icon-and-bubble">
                            <img src={photo} alt="Large M.int icon" className="large-mint-icon postloading-large-mint-icon" />
                    ...
                    <div className="welcome-container">
                        ...
                        <div className="welcome-text">
                            <h2>민트에 오신 것을 <br />환영합니다!</h2><br />
                            <p>민트는 용인시 노인분들과 함께하는 노인 복지플랫폼 입니다.</p><br />
                        </div>
                    </div>
                )}
